...
public class AlarmBroadcast extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        builder.setContentText("将有一个计划于"+config.getInt("ts",3)+"小时后开始").setContentTitle("便签通知").setSmallIcon(R.mipmap.ic_launcher).setPriority(Notification.PRIORITY_MAX).setVisibility(Notification.VISIBILITY_PUBLIC);
